	...
	<main class="app-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <div class="tile-body">
                            <form action="{{ route('backside.schedule.store') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" id="name_id" name="day">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" id="name_id" name="start_time">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" id="name_id" name="end_time">
